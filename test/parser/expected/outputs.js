var astList = {},
    ...
    testASTs = function() {
        ...
        astList.simple_if_elif_else = "(Program (Block (If yah (Block (is (x 1))) Elif nah (Block (is (x 2))) Else (Block (is (x 0))))))";
        ...
        astList.expressions = "(Program (Block (or yah nah) (and yah nah) (|| yah nah) (&& yah nah) (> 3 3) "
                                ...
                                + "(10 .. 40 by 2) (. f 1, 2) (While (3) (Return x)) (Function (x) (Return x))))"
