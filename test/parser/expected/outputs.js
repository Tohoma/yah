var astList = {},
    ...
    testASTs = function() {
        ...
        astList.expressions = "(Program (Block (or yah nah) (and yah nah) (|| yah nah) (&& yah nah) (> 3 3) " + "(+ (+ 5 10) 1) (/ 100 20) (! yah) (^ 4 2) (is (x [1,2,3])) (. (. x y) 2) " + "(10 .. 40 by 2) (FunCall f (1, 2)) (While (yah) (Return x)) (Function (x) (Return x)) " + "(. (FunCall id (arg, 1)) field)))";
        ...
        astList.primitives = "(Program (Block (is (a 2)) (is (b what)) (is (c yah)) (is (d nah)) (is (banana undefined)) " + "(is (apple nil)) (is (orange NaN)) (is (h [1,2,3,4,5])) (is (i (1,2,3,4,5))) " + "(is (j {(: 0 1),(: 2 3)})) (be ((. h 0) 6)) (be ((. i 0) 6)) (be ((. j 2) 5))))"
