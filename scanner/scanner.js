...
const DIGIT = /\d/;
const RESERVED_WORD = /is|be|yah|nah|spit|nil|undefined|NaN|print|for|while|in|and|or|if|elif|else|not|class|new|int|float|bool|string|list|tuple|dict|times|by|each/;
