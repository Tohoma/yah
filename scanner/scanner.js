...
const DIGIT = /\d/;
const RESERVED_WORD = /^(is|be|yah|nah|spit|return|nil|undefined|NaN|print|for|while|in|and|or|if|elif|else|not|eq|neq|gt|lt|geq|leq|class|new|int|float|bool|string|list|tuple|dict|times|by|each|global|local)$/;
